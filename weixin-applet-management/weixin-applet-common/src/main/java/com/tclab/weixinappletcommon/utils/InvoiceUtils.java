...
public class InvoiceUtils {
        ...
        public static String encrypt(String xmlStr) {
            ...
            byte[] md5Hasn = null;
            try {
                md5Hasn = InvoiceUtils.MD5Hash(encrypt, 0, encrypt.length);
            } catch (Exception e) {
                e.printStackTrace();
            }
            // 组合消息体
            byte[] totalByte = InvoiceUtils.addMD5(md5Hasn, encrypt);

            // 取密钥和偏转向量
            byte[] key = new byte[8];
            byte[] iv = new byte[8];
            getKeyIV(InvoiceUtils.key, key, iv);
            ...
            byte[] temp = null;
            try {
                temp = InvoiceUtils.DES_CBC_Encrypt(totalByte, deskey, ivParam);
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        public static String decrypt(String xmlStr) throws Exception {
            ...
            byte[] temp = null;
            try {
                temp = InvoiceUtils.DES_CBC_Decrypt(encBuf, deskey, ivParam);
            } catch (Exception e) {
                e.printStackTrace();
            }
            ...
            byte[] md5Hash = null;
            try {
                md5Hash = InvoiceUtils.MD5Hash(temp, 16, temp.length - 16);
            } catch (Exception e) {
                e.printStackTrace();
            }
...
//            String str=
//                    "{" +
//                            "\"identity\":\"B8FB14CA1C6D7C93D9154E2262FF0F9DD796B180A2A7690A\"," +
//                            "\"order\":" +
//                                "{" +
//                                    "\"orderno\":\"No.20160308151221\"," +
//                                    "\"saletaxnum\":\"110101MXB6CK9Q6\"," +
//                                    "\"saleaddress\":\"万塘路30号\"," +
//                                    "\"salephone\":\"0571-1234567\"," +
//                                    "\"saleaccount\":\"工商银行6222222222222\"," +
//                                    "\"clerk\":\"sa\"," +
//                                    "\"payee\":\"sa\"," +
//                                    "\"checker\":\"sa\"," +
//                                    "\"invoicedate\":\"2016-03-08 15:12:21\"," +
//                                    "\"ordertotal\":\"8.00\"," +
//                                    "\"kptype\":\"1\"," +
//                                    "\"taxtotal\":\"1.16\"," +
//                                    "\"bhtaxtotal\":\"6.84\"," +
//                                    "\"address\":\"浙江杭州 0571-123456789\"," +
//                                    "\"phone\":\"0571-123456789\"," +
//                                    "\"taxnum\":\"339900000000004\"," +
//                                    "\"buyername\":\"浙江爱信诺航天信息有限公司\"," +
//                                    "\"account\":\"工商-123456789浙江爱信诺航天信息有限公司\"," +
//                                    "\"message\":\"浙江爱信诺航天信息有限公司\"," +
//                                    "\"fpdm\":\"\"," +
//                                    "\"fphm\":\"\"," +
//                                    "\"detail\":[" +
//                                        "{" +

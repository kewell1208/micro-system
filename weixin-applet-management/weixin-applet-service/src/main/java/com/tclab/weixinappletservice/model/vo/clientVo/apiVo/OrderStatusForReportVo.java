...
public class OrderStatusForReportVo {
    ...
    private List<ReportBaseVo> goodBaseVos = new ArrayList<>();
    ...
    public List<ReportBaseVo> getGoodBaseVos() {
        return goodBaseVos;
    }

    public void setGoodBaseVos(List<ReportBaseVo> goodBaseVos) {
